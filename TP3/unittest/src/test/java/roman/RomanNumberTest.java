...
public class RomanNumberTest {
 ...
 public void fromRomanToDecimal() {
      assertThat(3051, is(RomanNumber.valueOf("MMMLI")));
  }
...
@Test
 public void fromDecimalToRoman() {
      assertThat("MMMLI", is(new RomanNumber(3051).toString()));
  }

// negative value
  @Test(expected = IllegalArgumentException.class)
  public void toRomanNegative() {
    RomanNumber.valueOf(-10);
  }

// float value
 /* @Test(expected = IllegalArgumentException.class)
  public void toRomanFloat() {
    RomanNumber.valueOf(10.5);
  }*/

// value [1,3999]
  @Test(expected = IllegalArgumentException.class)
  public void toRoman() {
    RomanNumber.valueOf(4500);
  }
...
// repetition paire value
  @Test(expected = IllegalArgumentException.class)
  public void toRomanRepetitionPaire() {
    RomanNumber.valueOf("LL");
  }

// antecedent value
  @Test(expected = IllegalArgumentException.class)
  public void toRomanAntecedent() {
    RomanNumber.valueOf("XCX");
  }

//all value between [1,3999]
  @Test
  public void fromRoman() {
	for(int n = 1 ; n < 4000 ; n++) {
    		assertThat(RomanNumber.valueOf(new RomanNumber(n).toString()), is(n));
	}
  }

// capital value
  @Test(expected = IllegalArgumentException.class)
  public void fromRomanCapital() {
    RomanNumber.valueOf("l");
  }

//capital value
  @Test
  public void toRomanCapital() {
    assertThat(new RomanNumber(10).toString(), is("X"));
  }
